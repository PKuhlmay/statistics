...
const models: Model[] = [
  ...
  },
  {
    ...
    strengths: ['Keine Feature-Skalierung nötig', 'Handles nicht-lineare Zusammenhänge', 'Feature Importance', 'Robust gegen Overfitting'],
  ...
  },
  {
    name: 'ExtraTrees',
    type: 'Ensemble (Bagging)',
    description: 'Wie Random Forest, aber mit zufälligeren Splits. Schneller trainiert und oft weniger Varianz.',
    strengths: ['Schneller als Random Forest', 'Noch weniger Overfitting', 'Feature Importance', 'Kein Feature-Scaling nötig'],
  ...
  },
  {
    ...
    weaknesses: ['Nur univariat', 'Kann bei irregulären Mustern versagen', 'Keine exogenen Variablen (standard)'],
    complexity: 2,
    interpretability: 4,
  ...
  },
  {
    ...
    strengths: ['Erfasst komplexe zeitliche Muster', 'Multivariat möglich', 'Kann lange Abhängigkeiten lernen'],
